...
import me.kyrobi.Tokoyami.utils.SystemInfo;
...
import static me.kyrobi.Tokoyami.utils.SystemInfo.getSystemInformation;
...
public class Stats extends ListenerAdapter {
    ...
    public void onMessageReceived(MessageReceivedEvent e){
        ...
        if(args[0].equalsIgnoreCase(Main.prefix + "stats")){
            ...
            eb.addField("Command Prefix", Main.prefix, true);
