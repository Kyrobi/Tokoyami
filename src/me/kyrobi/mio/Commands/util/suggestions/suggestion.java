package me.kyrobi.mio.Commands.util.suggestions;

import com.jagrosh.jdautilities.commons.waiter.EventWaiter;
import me.kyrobi.mio.Main;
import me.kyrobi.mio.utils.HelperFunctions;
...
public class suggestion extends ListenerAdapter {
    ...
    public suggestion(EventWaiter waiter){
        this.waiter = waiter;
    }
    ...
    public void onGuildMessageReceived(GuildMessageReceivedEvent e){
        ...
        if(args[0].equalsIgnoreCase(Main.prefix + "suggest")){
            ...
            FieldObject template = new FieldObject();
            ...
            if(suggestion.length() < 440){
                e.getChannel().sendMessage("Your suggestion is too short (" + suggestion.length() + " characters) - minimum of 440 characters. Please give more detail.").queue();
                return;
            }

            System.out.println("Length of suggestion: " + suggestion.length());
            System.out.println("Raw content: " + suggestion.toString());
